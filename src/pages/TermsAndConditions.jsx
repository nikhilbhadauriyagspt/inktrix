...
import { ChevronRight, FileText, Mail, MapPin, Phone, Scale } from 'lucide-react';
...
const TermsAndConditions = () => {
    ...
    const navItems = [
        ...
        { id: 'section-2', label: '2. Intellectual Property' },
        { id: 'section-3', label: '3. User Representations' },
        { id: 'section-4', label: '4. User Registration' },
        { id: 'section-5', label: '5. Products' },
        { id: 'section-6', label: '6. Purchases & Payment' },
        { id: 'section-7', label: '7. Return Policy' },
        { id: 'section-8', label: '8. Prohibited Activities' },
        { id: 'section-9', label: '9. User Contributions' },
        { id: 'section-10', label: '10. Contribution License' },
        { id: 'section-11', label: '11. Services Management' },
        { id: 'section-12', label: '12. Privacy Policy' },
        { id: 'section-13', label: '13. Term & Termination' },
        { id: 'section-14', label: '14. Modifications' },
        ...
        { id: 'section-19', label: '19. Liability Limitations' },
        { id: 'section-20', label: '20. Indemnification' },
        { id: 'section-21', label: '21. User Data' },
        { id: 'section-22', label: '22. Electronic Comms' },
        { id: 'section-23', label: '23. California Users' },
        { id: 'section-24', label: '24. Miscellaneous' },
        { id: 'section-25', label: '25. Contact Us' },
    ];
    ...
    return (
        <div className="bg-white min-h-screen font-sans selection:bg-brand-500 selection:text-white">
            <SEO 
                ...
                fallbackTitle="Terms and Conditions - InkTrix" 
                fallbackDesc="Read the InkTrix Terms and Conditions to understand your rights and obligations when using our services." 
            />
            ...
            <header className="bg-slate-50 border-b border-slate-200 pt-32 pb-16">
                <div className="container mx-auto px-6">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4 tracking-tight">Terms and Conditions</h1>
            ...
            <div className="container mx-auto px-6 py-16">
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <aside className="lg:w-1/4">
                        <div className="sticky top-32 bg-white border border-slate-200 rounded-xl p-6 hidden lg:block max-h-[70vh] overflow-y-auto no-scrollbar">
                            <h3 className="text-sm font-bold text-slate-900 uppercase tracking-wider mb-6 flex items-center gap-2">
                                <Scale size={16} className="text-brand-600" /> Legal Terms
                            </h3>
                            <nav className="space-y-1">
                                {navItems.map((item) => (
                                    <button
                                        ...
                                        className={`block text-left w-full text-xs py-2 px-3 rounded-lg transition-all ${
                    ...
                    <main className="lg:w-3/4">
                        ...
                        >
                            <section id="agreement">
                                <h2 className="text-2xl">AGREEMENT TO OUR LEGAL TERMS</h2>
                                <p>We are InkTrix ("Company," "we," "us," or "our"), a company registered in Texas, United States at 203 Texas Ave, Round Rock, TX 78664.</p>
                                <p>We operate the website <a href="https://inktrix.shop">https://inktrix.shop</a> (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").</p>
                                <p>At InkTrix, we’re passionate about providing high-quality ink and printer solutions that keep your world printing smoothly. From everyday home use to professional office needs, we offer a wide range of compatible inks, toners, and accessories designed for performance and value.</p>
                                <p>You can contact us by phone at +1-402-448-6127, email at inktrixshop@outlook.com, or by mail to 203 Texas Ave, Round Rock, TX 78664, United States.</p>
                                <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and InkTrix, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. <strong>IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</strong></p>
                            ...
                            <section id="section-1">
                                <h2 className="text-2xl pt-4">1. OUR SERVICES</h2>
                            ...
                            <section id="section-2">
                                <h2 className="text-2xl pt-4">2. INTELLECTUAL PROPERTY RIGHTS</h2>
                                ...
                                <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: inktrixshop@outlook.com. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
                            ...
                            <section id="section-3">
                                <h2 className="text-2xl pt-4">3. USER REPRESENTATIONS</h2>
                            ...
                            <section id="section-4">
                                <h2 className="text-2xl pt-4">4. USER REGISTRATION</h2>
                            ...
                            <section id="section-5">
                                <h2 className="text-2xl pt-4">5. PRODUCTS</h2>
                            ...
                            <section id="section-6">
                                <h2 className="text-2xl pt-4">6. PURCHASES AND PAYMENT</h2>
                            ...
                            <section id="section-7">
                                <h2 className="text-2xl pt-4">7. RETURN POLICY</h2>
                                <p>Please review our Return Policy prior to making any purchases: <a href="https://inktrix.shop/refund-policy">https://inktrix.shop/refund-policy</a>.</p>
                            </section>

                            <section id="section-8">
                                <h2 className="text-2xl pt-4">8. PROHIBITED ACTIVITIES</h2>
                            ...
                            <section id="section-9">
                                <h2 className="text-2xl pt-4">9. USER GENERATED CONTRIBUTIONS</h2>
                            ...
                            <section id="section-10">
                                <h2 className="text-2xl pt-4">10. CONTRIBUTION LICENSE</h2>
                            ...
                            <section id="section-11">
                                <h2 className="text-2xl pt-4">11. SERVICES MANAGEMENT</h2>
                            ...
                            <section id="section-12">
                                <h2 className="text-2xl pt-4">12. PRIVACY POLICY</h2>
                                <p>We care about data privacy and security. Please review our Privacy Policy: <a href="https://inktrix.shop/privacy-policy">https://inktrix.shop/privacy-policy</a>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.</p>
                            </section>

                            <section id="section-13">
                                <h2 className="text-2xl pt-4">13. TERM AND TERMINATION</h2>
                            ...
                            <section id="section-14">
                                <h2 className="text-2xl pt-4">14. MODIFICATIONS AND INTERRUPTIONS</h2>
                            ...
                            <section id="section-15">
                                <h2 className="text-2xl pt-4">15. GOVERNING LAW</h2>
                            ...
                            <section id="section-16">
                                <h2 className="text-2xl pt-4">16. DISPUTE RESOLUTION</h2>
                                ...
                                <p>If the Parties are unable to resolve a Dispute through informal negotiations, the Dispute (except those Disputes expressly excluded below) will be finally and exclusively resolved by binding arbitration. YOU UNDERSTAND THAT WITHOUT THIS PROVISION, YOU WOULD HAVE THE RIGHT TO SUE IN COURT AND HAVE A JURY TRIAL. The arbitration shall be commenced and conducted under the Commercial Arbitration Rules of the American Arbitration Association ("AAA") and, where appropriate, the AAA’s Supplementary Procedures for Consumer Related Disputes ("AAA Consumer Rules"), both of which are available at the American Arbitration Association (AAA) website. Your arbitration fees and your share of arbitrator compensation shall be governed by the AAA Consumer Rules and, where appropriate, limited by the AAA Consumer Rules. The arbitration may be conducted in person, through the submission of documents, by phone, or online. The arbitrator will make a decision in writing, but need not provide a statement of reasons unless requested by either Party. The arbitrator must follow applicable law, and any award may be challenged if the arbitrator fails to do so. Except where otherwise required by the applicable AAA rules or applicable law, the arbitration will take place in Texas, United States. Except as otherwise provided herein, the Parties may litigate in court to compel arbitration, stay proceedings pending arbitration, or to confirm, modify, vacate, or enter judgment on the award entered by the arbitrator.</p>
                                <p>If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the state and federal courts located in Texas, United States, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction, and forum non conveniens with respect to venue and jurisdiction in such state and federal courts.</p>
                                <p>Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Legal Terms.</p>
                            ...
                            <section id="section-17">
                                <h2 className="text-2xl pt-4">17. CORRECTIONS</h2>
                                <p>There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.</p>
                            </section>

                            <section id="section-18">
                                <h2 className="text-2xl pt-4">18. DISCLAIMER</h2>
                            ...
                            <section id="section-19">
                                <h2 className="text-2xl pt-4">19. LIMITATIONS OF LIABILITY</h2>
                            ...
                            <section id="section-20">
                                <h2 className="text-2xl pt-4">20. INDEMNIFICATION</h2>
                            ...
                            <section id="section-21">
                                <h2 className="text-2xl pt-4">21. USER DATA</h2>
                                <p>We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.</p>
                            </section>

                            <section id="section-22">
                                <h2 className="text-2xl pt-4">22. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
                            ...
                            <section id="section-23">
                                <h2 className="text-2xl pt-4">23. CALIFORNIA USERS AND RESIDENTS</h2>
                                <p>If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.</p>
                            </section>

                            <section id="section-24">
                                <h2 className="text-2xl pt-4">24. MISCELLANEOUS</h2>
                            ...
                            <section id="section-25">
                                <h2 className="text-2xl pt-4">25. CONTACT US</h2>
                                <p>In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at:</p>
                                <div className="bg-slate-900 text-slate-100 p-8 rounded-xl flex flex-col md:flex-row gap-8 justify-between">
                                    <div>
                                        <h4 className="text-white font-bold mb-4">Contact Details</h4>
                                        <div className="space-y-3 text-sm">
                                            <p className="flex items-center gap-2 font-bold text-white">InkTrix</p>
