...
const Home = () => {
    ...
    return (
        <div className="bg-white min-h-screen relative font-sans selection:bg-brand-500 selection:text-white">
                ...
                <div className="container mx-auto px-6">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        <div className="flex flex-col items-center text-center">
                            <span className="text-3xl font-serif text-neutral-900 mb-1 tracking-tighter">Genuine</span>
                            <span className="text-[10px] font-black text-brand-600 uppercase tracking-widest">Certified Hardware</span>
                        </div>
                        <div className="flex flex-col items-center text-center">
                            <span className="text-3xl font-serif text-neutral-900 mb-1 tracking-tighter">Fast</span>
                            <span className="text-[10px] font-black text-brand-600 uppercase tracking-widest">Efficient Delivery</span>
                        </div>
                        <div className="flex flex-col items-center text-center">
                            <span className="text-3xl font-serif text-neutral-900 mb-1 tracking-tighter">Support</span>
                            <span className="text-[10px] font-black text-brand-600 uppercase tracking-widest">Technical Assistance</span>
                        </div>
                        <div className="flex flex-col items-center text-center">
                            <span className="text-3xl font-serif text-neutral-900 mb-1 tracking-tighter">Secure</span>
                            <span className="text-[10px] font-black text-brand-600 uppercase tracking-widest">Encrypted Payments</span>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid lg:grid-cols-2 gap-24 items-center">
                        <div className="relative order-2 lg:order-1">
                            <div className="aspect-[4/5] rounded-[4rem] overflow-hidden border-8 border-white shadow-2xl relative z-10">
                                <img src="/category/Laser.jpg" className="w-full h-full object-cover" alt="Atelier" />
                            </div>
                        ...
                        <div className="order-1 lg:order-2">
                            ...
                            <div className="grid grid-cols-2 gap-12 pt-12 border-t border-neutral-100">
                                <div>
                                    <p className="text-5xl font-serif text-neutral-900 mb-2 tracking-tighter">Certified</p>
                                    <p className="text-neutral-400 text-[10px] font-bold uppercase tracking-widest">Quality Gear</p>
                                </div>
                                <div>
                                    <p className="text-5xl font-serif text-neutral-900 mb-2 tracking-tighter">Support</p>
                                    <p className="text-neutral-400 text-[10px] font-bold uppercase tracking-widest">Technical Assistance</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {/* --- SECTION 9: PROFESSIONAL STANDARDS --- */}
            <section className="py-24 bg-neutral-50 overflow-hidden">
                <div className="container mx-auto px-6">
                    <div className="text-center max-w-2xl mx-auto mb-20">
                        <p className="text-brand-600 font-black text-[10px] uppercase tracking-[0.4em] mb-4">Our Standards</p>
                        <h2 className="text-4xl md:text-6xl font-serif text-neutral-900 tracking-tight">Professional <span className="italic text-brand-500">Commitment.</span></h2>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            { title: "Quality Verification", icon: <ShieldCheck size={24} />, text: "Every product in our inventory undergoes a rigorous quality inspection to ensure performance excellence." },
                            { title: "Technical Support", icon: <Headphones size={24} />, text: "Our team provides comprehensive technical assistance to help you optimize your hardware workspace." },
                            { title: "Global Logistics", icon: <Truck size={24} />, text: "We utilize specialized handling protocols to ensure your equipment arrives in pristine condition, regardless of distance." }
                        ].map((item, i) => (
                            <div key={i} className="bg-white p-10 rounded-[3rem] border border-neutral-100 shadow-sm hover:shadow-2xl transition-all duration-500 group text-center">
                                <div className="w-16 h-16 bg-brand-50 rounded-2xl flex items-center justify-center text-brand-600 mx-auto mb-8 group-hover:bg-brand-500 group-hover:text-white transition-all duration-500">
                                    {item.icon}
                                </div>
                                <h4 className="text-neutral-900 font-bold text-xl mb-4">{item.title}</h4>
                                <p className="text-neutral-500 text-sm leading-relaxed font-light">{item.text}</p>
                            </div>
                        ))}
                    </div>
                </div>
